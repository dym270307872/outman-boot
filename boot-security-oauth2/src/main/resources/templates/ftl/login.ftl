...
<body class="sign_body">
	<div class="container form-margin-top">
		<form class="form-signin" action="/token/form" method="post"
			...
			<input type="text" id="username" name="username"
				class="form-control form-margin-top" placeholder="账号" required
	...
	<footer>
		<p>support by: xxxxx</p>
		<p>
			email: <a href="javascript:void(0)">xxxxx.email@qq.com</a>.
		</p>
	</footer>
</body>
</html>
