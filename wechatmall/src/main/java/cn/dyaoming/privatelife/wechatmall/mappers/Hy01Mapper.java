...
public interface Hy01Mapper extends Mapper<Hy01> {
    ...
    @Update("update hy01 set hya002=#{hya002},hya021=hya021+#{hya021} where hya001=#{hya001}")
    int updateCard(Hy01 hy01);

    @Update("update hy01 set hya003=#{hya003} where hya001=#{hya001}")
    int updatePassword(Hy01 hy01);
    ...
    List<Map> findBalanceMxByType(@Param("hya001") String hya001, @Param("type") String type);
